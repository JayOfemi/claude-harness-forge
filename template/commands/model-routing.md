...
Operate the model-routing switch (`STANDARDS/model-routing.md`, "The adopted rails"). Routing is delegation-based and independent of the main session's model: the session orchestrates on whatever model the user picked, and stage work goes to four pinned subagents at `~/.claude/agents/`: `Explore.md`, `Plan.md`, `Execute.md`, `Review.md`.
