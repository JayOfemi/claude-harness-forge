...
Start your report with one line naming the model you are actually running as (from your system context), so the caller can log requested vs effective tier. This agent is pinned by the model-routing switch (`STANDARDS/model-routing.md`).
